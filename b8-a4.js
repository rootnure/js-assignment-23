...
// console.log(canPay([2, 1, 5, 2, 1], 1+2)); // 5
// console.log(findAddress({street:10,society:"Earth Perfect",house:"150000A"})); // 4
// console.log(sortMaker([10, 21])); // 3
// console.log(matchFinder('Peter Parker','Park')); // 2
// console.log(cubeNumber(100)); // 1